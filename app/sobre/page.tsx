    ...
    <main className="min-h-screen bg-gray-900 px-6 py-12">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          ...
          {/* Texto */}
          <div>
            <h2 className="mb-5 text-3xl font-bold text-gray-50">
              Bem-vindo ao Dançakuduro
            </h2>

            <p className="mb-5 text-lg leading-8 text-gray-500">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="rounded-xl bg-white p-4 text-center shadow-sm cursor-pointer hover:scale-110 transition-all duration-300">
